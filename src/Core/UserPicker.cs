...
<li class=""{0}"">
    <a href=""{1}?{2}={3}&{4}={5}"" class=""stuntman-item"">
        <h3>{6}{7}</h3>
            ...
            items.Add($@"
<li>
    <a href=""{_options.SignOutUri}?{StuntmanOptions.ReturnUrlQueryStringKey}={WebUtility.UrlEncode(returnUrl)}"" class=""stuntman-item"">
        <h3>Logout</h3>
    </a>
</li>");
